...
// Schema para insertMetric (se você for criar métricas via API diretamente)
...
// export type InsertMetric = z.infer<typeof insertMetricSchema>; // Agora definido acima
