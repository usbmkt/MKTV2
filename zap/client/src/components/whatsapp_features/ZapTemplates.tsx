...
const defaultNewTemplateDataState: Partial<MessageTemplate> = {
  ...
  components: [
    { type: 'BODY', text: '' },
     // { type: 'BUTTONS', buttons: [] } // Pode ser inicializado assim se preferir
  ]
};
          ...
          <form id="template-form-id" onSubmit={handleSubmit} className="flex-grow overflow-y-auto p-6 space-y-4 custom-scrollbar">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="space-y-1.5">
                    ...
                    <Select name="category" value={newTemplateData.category || 'UTILITY'} onValueChange={(v: string) => handleSelectChange('category', v as MessageTemplate['category'])}>
                ...
                <div className="space-y-1.5">
                    ...
                    <Select name="language" value={newTemplateData.language || 'pt_BR'} onValueChange={(v: string) => handleSelectChange('language', v)}>
