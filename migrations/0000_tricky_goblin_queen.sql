...
CREATE TABLE "whatsapp_messages" (
	...
	"is_read" boolean DEFAULT false NOT NULL,
	"flow_id" integer,
	"message_id_baileys" text,
	CONSTRAINT "whatsapp_messages_message_id_baileys_unique" UNIQUE("message_id_baileys")
);
--> statement-breakpoint
...
CREATE UNIQUE INDEX "whatsapp_template_user_name_idx" ON "whatsapp_message_templates" USING btree ("user_id","template_name");