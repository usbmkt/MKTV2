-- Corrigido para ser idempotente (CREATE TYPE)
DO $$ BEGIN
...
-- Corrigido para ser idempotente (CREATE TABLE)
...
-- Corrigido para ser idempotente (ADD CONSTRAINT)
DO $$
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'alerts_user_id_users_id_fk' AND conrelid = 'public.alerts'::regclass
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'alerts_campaign_id_campaigns_id_fk' AND conrelid = 'public.alerts'::regclass
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'budgets_user_id_users_id_fk' AND conrelid = 'public.budgets'::regclass
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'budgets_campaign_id_campaigns_id_fk' AND conrelid = 'public.budgets'::regclass
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'campaigns_user_id_users_id_fk' AND conrelid = 'public.campaigns'::regclass
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'chat_messages_session_id_chat_sessions_id_fk' AND conrelid = 'public.chat_messages'::regclass
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'chat_sessions_user_id_users_id_fk' AND conrelid = 'public.chat_sessions'::regclass
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'copies_user_id_users_id_fk' AND conrelid = 'public.copies'::regclass
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'copies_campaign_id_campaigns_id_fk' AND conrelid = 'public.copies'::regclass
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'creatives_user_id_users_id_fk' AND conrelid = 'public.creatives'::regclass
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'creatives_campaign_id_campaigns_id_fk' AND conrelid = 'public.creatives'::regclass
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'funnel_stages_funnel_id_funnels_id_fk' AND conrelid = 'public.funnel_stages'::regclass
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'funnels_user_id_users_id_fk' AND conrelid = 'public.funnels'::regclass
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'funnels_campaign_id_campaigns_id_fk' AND conrelid = 'public.funnels'::regclass
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'landing_pages_user_id_users_id_fk' AND conrelid = 'public.landing_pages'::regclass
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'metrics_campaign_id_campaigns_id_fk' AND conrelid = 'public.metrics'::regclass
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'metrics_user_id_users_id_fk' AND conrelid = 'public.metrics'::regclass
    ) THEN
...
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint WHERE conname = 'whatsapp_messages_user_id_users_id_fk' AND conrelid = 'public.whatsapp_messages'::regclass
    ) THEN
